...
/**
 * @brief Sets the user's preferred brightness to the system brightness.
 * @details This API is useful when the application need to change the brightness of the screen.
 *          If the application set the brightness 0 to 100 and the application window is shown wholly or partially,
