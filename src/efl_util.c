...
static void                    _cb_device_add(void *data EINA_UNUSED, struct tizen_input_device_manager *tizen_input_device_manager EINA_UNUSED, uint32_t serial, const char *name, struct tizen_input_device *device, struct wl_seat *seat);
static void                    _cb_device_remove(void *data EINA_UNUSED, struct tizen_input_device_manager *tizen_input_device_manager EINA_UNUSED, uint32_t serial, const char *name, struct tizen_input_device *device, struct wl_seat *seat);
...
static void                    _cb_generate_key_notify(void *data EINA_UNUSED, struct tizen_input_device_manager *tizen_input_device_manager EINA_UNUSED, const char *keyname, uint32_t pressed, uint32_t ret);
static void                    _cb_generate_pointer_notify(void *data EINA_UNUSED, struct tizen_input_device_manager *tizen_input_device_manager EINA_UNUSED, uint32_t type, uint32_t x, uint32_t y, uint32_t button, uint32_t ret);
static void                    _cb_generate_touch_notify(void *data EINA_UNUSED, struct tizen_input_device_manager *tizen_input_device_manager EINA_UNUSED, uint32_t type, uint32_t x, uint32_t y, uint32_t finger, uint32_t ret);
...
struct tizen_input_device_manager_listener _wl_tz_devmgr_listener =
{
   ...
   _cb_error,
   _cb_block_expired,
   _cb_generate_key_notify,
   _cb_generate_pointer_notify,
   _cb_generate_touch_notify
};
...
static void
_cb_generate_key_notify(void *data EINA_UNUSED,
                        struct tizen_input_device_manager *tizen_input_device_manager EINA_UNUSED,
                        const char *keyname, uint32_t pressed, uint32_t ret)
{
   _eflutil.wl.devmgr.request_notified = ret;
}

static void
_cb_generate_pointer_notify(void *data EINA_UNUSED,
                            struct tizen_input_device_manager *tizen_input_device_manager EINA_UNUSED,
                            uint32_t type, uint32_t x, uint32_t y, uint32_t button, uint32_t ret)
{
   _eflutil.wl.devmgr.request_notified = ret;
}

static void
_cb_generate_touch_notify(void *data EINA_UNUSED,
                          struct tizen_input_device_manager *tizen_input_device_manager EINA_UNUSED,
                          uint32_t type, uint32_t x, uint32_t y, uint32_t finger, uint32_t ret)
{
   _eflutil.wl.devmgr.request_notified = ret;
}
#endif /* end of WAYLAND */
